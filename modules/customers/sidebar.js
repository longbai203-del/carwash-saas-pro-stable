...
window.SidebarComponent = {
    ...
    render: function(container) {
        ...
        this._menuItems.forEach(function(item) {
            var show = perms.includes(item.module) || perms.length === 0;
            if (show) {
    ...
    bindEvents: function(container) {
        var self = this;
        container.querySelectorAll('[data-module]').forEach(function(el) {
            el.addEventListener('click', function(e) {
                ...
                container.querySelectorAll('[data-module]').forEach(function(item) {
