...
-- ============================================================
-- 第一部分：多租户与用户体系 (Multi-Tenant & Users)
-- ============================================================
...
CREATE TABLE customer_points_history (
    ...
    type VARCHAR(20), -- earned, redeemed, expired
...
CREATE TABLE coupons (
    ...
    name VARCHAR(100) NOT NULL,
    type VARCHAR(20) NOT NULL, -- fixed, percentage, free
...
CREATE TABLE inventory_logs (
    ...
    change_type VARCHAR(20) NOT NULL, -- sale, purchase, adjustment, transfer, return
...
-- ============================================================
-- 第五部分：采购与供应商 (Purchase & Suppliers)
-- ============================================================
